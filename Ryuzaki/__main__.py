...
from Ryuzaki.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Ryuzaki.modules." + module_name)
...
@run_async
def Ryuzakibot_about_callback(update, context):
    query = update.callback_query
    if query.data == "Ryuzakibot_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="Ryuzakibot_back")
                 ]
                ]
            ),
        )
    elif query.data == "Ryuzakibot_back":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Ryuzaki*
                 \nHere is the [Source Code](https://github.com/TeamRyuzaki/Ryuzakibot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(Ryuzakibot_about_callback, pattern=r"Ryuzakibot_")
