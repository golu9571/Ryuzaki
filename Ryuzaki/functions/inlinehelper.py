...
from Ryuzaki import BOT_USERNAME, OWNER_ID
from Ryuzaki.functions.pluginhelpers import convert_seconds_to_minutes as time_convert
from Ryuzaki.functions.pluginhelpers import fetch
from Ryuzaki import arq, pgram as pgram
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/Ryuzaki"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )
