...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import Ryuzaki.events

        path = Path(f"Ryuzaki/modules/{shortname}.py")
        name = "Ryuzaki.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["Ryuzaki.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Ryuzaki/modules/*.py"
