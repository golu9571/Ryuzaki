...
import Ryuzaki.modules.sql.welcome_sql as sql
import Ryuzaki
from Ryuzaki import (
    DEV_USERS,
    LOGGER,
...
from Ryuzaki.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Ryuzaki.modules.helper_funcs.msg_types import get_welcome_type
from Ryuzaki.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Ryuzaki.modules.log_channel import loggable
from Ryuzaki.modules.sql.global_bans_sql import is_user_gbanned
...
def welcome(update: Update, context: CallbackContext):
    ...
    if not args or args[0].lower() == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text(
                "I'll go loaf around and not welcome anRyuzakibot then."
            )
