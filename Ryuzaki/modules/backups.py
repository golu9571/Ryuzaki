...
import Ryuzaki.modules.sql.notes_sql as sql
from Ryuzaki import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Ryuzaki.__main__ import DATA_IMPORT
from Ryuzaki.modules.helper_funcs.chat_status import user_admin
from Ryuzaki.modules.helper_funcs.alternate import typing_action

# from Ryuzaki.modules.rules import get_rules
import Ryuzaki.modules.sql.rules_sql as rulessql

# from Ryuzaki.modules.sql import warns_sql as warnssql
import Ryuzaki.modules.sql.blacklist_sql as blacklistsql
from Ryuzaki.modules.sql import disable_sql as disabledsql

# from Ryuzaki.modules.sql import cust_filters_sql as filtersql
# import Ryuzaki.modules.sql.welcome_sql as welcsql
import Ryuzaki.modules.sql.locks_sql as locksql
from Ryuzaki.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Ryuzaki{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Ryuzaki{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Ryuzaki-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Ryuzaki{}.backup".format(chat_id))  # Cleaning file
