...
import Ryuzaki.modules.sql.global_bans_sql as gban_sql
import Ryuzaki.modules.sql.users_sql as user_sql
from Ryuzaki import DEV_USERS, OWNER_ID, dispatcher
